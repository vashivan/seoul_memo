  ...
  items: [
    {
      ...
      description:
        "це легкий веганський гель-крем із 77% води з насіння вівса, призначений для заспокоєння, глибокого зволоження та відновлення чутливої, сухої або подразненої шкіри. Завдяки сквалану та пантенолу, засіб зміцнює бар'єр шкіри, зменшує почервоніння та миттєво вбирається, не залишаючи липкості",
      variants: [
    ...
    },
    {
      ...
      description:
        "інтенсивно зволожуюча тканинна маска, розроблена для глибокого зволоження, заспокоєння та усунення сухості. Завдяки комплексу з 5 видів гіалуронової кислоти, пантенолу та алантоїну, вона миттєво робить шкіру гладкою, пружною та сяючою, підходить для чутливої шкіри.",
      variants: [
    ...
    {
      id: 3,
      name: "Laneige Lip Sleeping Mask (4 аромати)",
      description:
        "це популярна корейська нічна маска, яка інтенсивно живить, зволожує та відновлює суху, потріскану шкіру губ під час сну. Завдяки комплексу ягідних екстрактів (Berry Mix Complex), оліям ши та мурумуру, вона робить губи м'якими, гладкими та еластичними, усуваючи лущення.",
      variants: [
